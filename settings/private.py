...
#The values have been set up on Heroku as environment variables because otherwise the only way to 
#enable heroku to work was to upload this file to github, defeating the object of it. 
...
STRIPE_SECRET = 'sk_test_AVtmQrxAW5mVkGxRQsDZpnG0'
